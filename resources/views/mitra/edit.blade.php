<div id="modal-edit" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="mitra-edit" method="post" enctype="multipart/form-data" files=true>
            @method('PUT')
            @csrf
...
$(document).ready(function(){
    /* START OF SAVE DATA */
		$('#mitra-edit').on('submit', function (e) {
      e.preventDefault();
        $.ajax({
            'type': 'post',
            'url' : "{{ url('admin/mitra') }}"+"/"+$('input[name=id_edit]').val(),
