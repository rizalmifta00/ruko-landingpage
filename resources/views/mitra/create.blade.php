    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Create Mitra</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <form class="form-horizontal" id="mitra-store" method="post" enctype="multipart/form-data" files=true>
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label>Mitra Picture</label>
...
<script type="text/javascript">
    $(document).ready(function () {
        /* save data */
        $('#mitra-store').on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                'type': 'POST',
