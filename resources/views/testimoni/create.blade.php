...
<div id="modal-create" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="testimoni-store" method="post" enctype="multipart/form-data" files=true>
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" rows="3" cols="3" name="testimoni" class="form-control"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#testimoni-store').on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                'type': 'POST',
