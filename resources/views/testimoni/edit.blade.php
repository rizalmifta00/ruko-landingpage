<div id="modal-edit" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="testimoni-edit" method="post" enctype="multipart/form-data" files=true>
            @method('PUT')
            @csrf
                <input type="hidden" name="id_edit">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Testimoni Picture</label>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea type="text" rows="3" cols="3" name="testimoni_edit" class="form-control"
...
$(document).ready(function(){
    /* START OF SAVE DATA */
		$('#testimoni-edit').on('submit', function (e) {
      e.preventDefault();
        $.ajax({
            'type': 'post',
            'url' : "{{ url('admin/testimoni') }}"+"/"+$('input[name=id_edit]').val(),
