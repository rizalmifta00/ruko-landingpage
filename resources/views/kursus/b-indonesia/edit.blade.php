<div id="modal-edit-b-indonesia" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Kursus Bahasa Indonesia</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <form class="form-horizontal" id="b-indonesia-edit" method="post" enctype="multipart/form-data" files=true>
            @csrf
                <input type="hidden" name="id_edit">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Picture</label>
                        <div id="img-edit-b-indonesia" class="col-lg-9"></div>
...
$(document).ready(function(){
    /* START OF SAVE DATA */
    $('#b-indonesia-edit').on('submit', function (e) {
      e.preventDefault();
        $.ajax({
            'type': 'post',
            'url' : "{{ url('admin/b-indonesia') }}"+"/"+$('input[name=id_edit]').val(),
            ...
            'success': function(data){
                if(data.success){
                    $('#modal-edit-b-indonesia').modal('hide');
