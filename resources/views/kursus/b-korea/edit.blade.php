<div id="modal-edit-b-korea" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Kursus Bahasa Korea</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <form class="form-horizontal" id="b-korea-edit" method="post" enctype="multipart/form-data" files=true>
            @csrf
                <input type="hidden" name="id_edit">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Picture</label>
                        <div id="img-edit-b-korea" class="col-lg-9"></div>
...
$(document).ready(function(){
    /* START OF SAVE DATA */
    $('#b-korea-edit').on('submit', function (e) {
      e.preventDefault();
        $.ajax({
            'type': 'post',
            'url' : "{{ url('admin/b-korea') }}"+"/"+$('input[name=id_edit]').val(),
