<div id="modal-edit-ingin-korea" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="universitas-edit" method="post" enctype="multipart/form-data" files=true>
            @method('PUT')
            @csrf
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div id="img-edit-ingin-korea" class="col-lg-9"></div>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input-styled-primary" type="radio" name="negara_edit" id="indo-edit" value="indo">
                                <label class="form-check-label ml-2" for="inlineRadio1">Indo</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input-styled-danger" type="radio" name="negara_edit" id="korea-edit" value="korea">
...
$(document).ready(function(){
    /* START OF SAVE DATA */
    $('#universitas-edit').on('submit', function (e) {
      e.preventDefault();
        $.ajax({
            'type': 'post',
            'url' : "{{ url('admin/universitas') }}"+"/"+$('input[name=id_edit]').val(),
            ...
            'success': function(data){
                if(data.success){
                    $('#modal-edit-ingin-korea').modal('hide');
